    ...
    <div className="ops-panel flex h-full flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-zinc-800/80 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-[11px] uppercase tracking-[0.16em] font-semibold text-zinc-300">
            Live Threat Feed
          </h3>
        </div>
        <Link
          href="/incidents"
          className="text-[11px] text-zinc-500 hover:text-emerald-300 flex items-center gap-0.5 transition-colors"
        >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mb-0.5">
                  ...
                  <span className="text-[12px] font-medium text-zinc-200 truncate group-hover:text-emerald-300 transition-colors">
